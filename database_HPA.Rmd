...
```{r, echo=FALSE, fig.alt="Screenshot of the top of the Human Protein Atlas page for INS, showing two tables.  The Information table contains basic information about the protein including its name (Insulin), Gene name (INS), and Protein class (Cancer-related genes, Candidate cardiovascular disease genes, Disease related genes, Human disease related genes, Plasma proteins, RAS pathway related proteins).  The Protein Expression and Localization table summarizes insulin localization, including Tissue profile (Highly selective cytoplasmic expression in pancreatic islets), Subcellular location (Not available), and Extracellular location (Secreted to blood).", fig.cap = "Katherine Cox (2023). Screenshot of the top of the Human Protein Atlas page for INS https://www.proteinatlas.org/ENSG00000254647-INS. License: [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/)"}
...
Further down the page we can see more information about the protein:
