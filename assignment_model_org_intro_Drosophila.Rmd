...
1. Work through the *Drosophila melanogaster* tutorial on SciServer
  1. If you can’t access the tutorial on SciServer, [click here to open a static copy of the Drosophila melanogaster tutorial](https://science.c-moor.org/module-model-org-db/model-org-drosophila.html){target="_blank"}.
1. As you complete the lesson, answer the questions below.
